...
public class SecurityConfig {
	...
	public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
		http.csrf().disable().authorizeRequests()
				.antMatchers("/api/v1/auth/login", "/api/v1/auth/register", "/api/v1/auth/authenticate").permitAll() // Public
																														// access
				.antMatchers("/api/v1/employees/sendEmail", "/api/v1/employees/create", "/api/v1/employees/update/**",
